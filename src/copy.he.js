...
export const C = {
  ...
  onboarding: {
    ...
    licenseSub:         'רישיון תקף נדרש לגישה לקהילה ולדיווחים. הנתונים שמרנו: תאריך תפוגה בלבד — שאר הפרטים נמחקים.',
    licenseUpload:      'העלאת רישיון / צילום',
    licenseSkip:        'אמשיך בלי קהילה — רק מוצרים',
    licenseScanning:    'בודק... 🔍',
    licenseOk:          'רישיון תקף ✅',
    licenseExpired:     'נראה שהרישיון פג תוקף. ניתן להמשיך בכל זאת — אבל קהילה תהיה נעולה.',
  ...
  community: {
    ...
    allEmpty:           'הקהילה רק מתחילה 🌱\nהיה הראשון לשתף — כולנו נרוויח.',
    lockedTitle:        'הקהילה מחכה לך 👥',
    lockedSub:          'כדי לגשת לקהילה יש צורך ברישיון תקף.\nהפרטים שלך — אנונימיים לחלוטין.',
